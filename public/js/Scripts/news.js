/**
 * Created by www.hejigy.cn on 15-04-17.
 */
$(document).ready(function(){
    var url=window.location.href;
    if(url.indexOf('news')!=-1){
        $('#menu4').find('a').css('color','#1772BD');
        $('#menu4').siblings().find('a').css('color','#565656');
    }
...
function search_news() {
    var k = $("#k").val();
    document.location = "../../../News/search-k=.htm"+ encodeURI(k);
}
